...
// Slightly edited because I think it was made with Qt5 in mind???
Item{
    id: root
    ...
    property string type: "info" //info, success, warning, error, undo, redo
    property int position: Qt.TopLeftCorner //Qt.*****Corner
    property string theme: "Light" //Light, Dark, Color
    property int autoClose: 3000 //0 means no auto close
    ...
    Rectangle{
        ...
        RowLayout{
            ...
            Image {
                ...
                source: type == "warning"? "assets/warning.svg" :
                        type == "error"? "assets/error.svg" :
                        "assets/add.svg" //`icons/${type}${theme==="Light" ? "":"-white"}.svg`
            }
